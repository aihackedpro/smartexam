...
การตรวจจากภาพเป็นแบบ **ครูยืนยัน** เพื่อไม่เดาคำตอบที่ไม่ชัดเจน ส่วน Cloud sync,
ระบบออก Activate Key และ OMR อัตโนมัติยังไม่เชื่อมบริการ production
...
- ถ่ายหรือเลือกภาพกระดาษคำตอบและให้ครูยืนยัน/ทำเครื่องหมายรอตรวจ
...
- สำรอง/กู้คืนข้อมูลเป็น JSON และ Activate Key แบบออฟไลน์
